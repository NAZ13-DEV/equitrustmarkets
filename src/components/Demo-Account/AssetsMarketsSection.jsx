      ...
      <div className='bg-[rgb(7,14,32)] text-white flex-1 flex items-center px-6 py-12 lg:py-24'>
        <div className='max-w-xl'>
          <h2 className='text-4xl lg:text-5xl font-bold mb-6 leading-tight'>
            Explore Optima Trade Market assets <br /> and markets
          </h2>
          <p className='text-base lg:text-lg mb-8'>
            Learn to trade with our various assets from leading global financial
            markets with the same conditions as on live trading accounts.
          </p>
          <Link
            to={'/register'}
