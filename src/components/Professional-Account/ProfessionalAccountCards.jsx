  ...
  return (
    <section className='bg-white py-20 px-4'>
      <div className='max-w-7xl mx-auto text-center mb-12'>
        ...
        >
          Optima Trade Marketoffers flexible account types tailored for every
          level of trader.
        </motion.p>
      </div>
        ...
        {accounts.map((acc, idx) => (
          ...
          >
            ...
            <ul className='space-y-3 text-sm text-gray-600'>
              <li>
                <strong className='text-green-700'>Minimum deposit:</strong>{' '}
                {acc.deposit}
              </li>
              <li>
              ...
              <li>
                <strong className='text-green-700'>Commission:</strong>{' '}
                {acc.commission}
              </li>
              <li>
                <strong className='text-green-700'>Maximum leverage:</strong>{' '}
                {acc.leverage}
              </li>
              <li>
                <strong className='text-green-700'>Instruments:</strong>{' '}
                {acc.instruments}
              </li>
            </ul>
            <br />
            <Link
              to={'/register'}
              className='mt-6 w-full bg-green-600 text-white py-2 rounded hover:bg-green-700 transition px-2 '
            >
              Register
            </Link>
          </motion.div>
