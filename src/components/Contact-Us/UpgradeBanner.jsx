        ...
        <div className='bg-[#0f1923] text-white px-5 py-4 md:px-6 md:py-5 rounded-lg w-full max-w-4xl flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-lg'>
          <div>
            ...
            <p className='text-[13px] md:text-sm text-[#b1b5c3] mt-[2px] leading-snug'>
              See for yourself why Optima Trade Marketis the broker of choice
              for over 1 million traders and 100,000 partners.
            </p>
          </div>
          ...
          <div className='flex gap-2 md:gap-3'>
            <Link
              to={'/register'}
              className='bg-[#07A658] hover:bg-[#05944f] text-white text-[13px] font-semibold px-4 py-2 rounded transition'
            >
              Register
            </Link>
            <Link
              to={'/register'}
              className='bg-[#2b2e38] hover:bg-[#3a3d47] text-white text-[13px] font-semibold px-4 py-2 rounded transition'
            >
              Try free demo
            </Link>
          </div>
