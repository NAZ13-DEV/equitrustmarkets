    ...
    <section className='bg-white py-20 px-4 text-center'>
      ...
      >
        <h2 className='text-3xl md:text-4xl font-bold mb-4'>
          Why trade crypto with Optima Trade Market
        </h2>
        <p className='text-gray-600 max-w-2xl mx-auto'>
          From Bitcoin to Ethereum and more, you can trade digital assets
          against the USD with fast, secure, and cost-effective execution at
          Optima Trade Market.
        </p>
      </motion.div>
        ...
        {[
          {
            ...
            text: 'Withdraw your funds quickly with no delays. Choose your preferred method and enjoy fast approvals from Optima Trade Market.',
          },
          {
            icon: circleTrade,
