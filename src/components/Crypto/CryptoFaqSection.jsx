...
const faqs = [
  ...
  {
    question: 'How do I decide the best cryptocurrencies to trade in the 2024 crypto market?',
    answer:
      'It depends on market trends, liquidity, volatility, and your trading strategy. Always research before investing and use Equitrustmarkets tools to analyze performance.'
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes! The crypto market is open 24/7, including weekends, allowing you to trade anytime using Equitrustmarkets’ platform.'
  },
  {
    question: 'How do you deal with price gaps?',
    answer:
      'Equitrustmarkets uses fast execution and advanced algorithms to minimize the impact of price gaps during high volatility events.'
  },
  {
    question: 'What are your rules for pending orders, stop loss (SL), and take profit (TP)?',
    answer:
