    ...
    <section className='bg-white text-gray-900 px-6 md:px-12 py-16 max-w-6xl mx-auto'>
      ...
      >
        ...
        <p className='text-gray-600 mb-4'>
          ...
          another using recent exchange rate data. An essential tool when making
          deposits and withdrawals on your trading account.
        </p>
        <ul className='text-left text-gray-700 list-disc list-inside space-y-2'>
          ...
          <li>
            The currency converter will automatically calculate and display the
            exchange rates for your chosen currencies.
          </li>
        </ul>
      </motion.div>

      {/* Why Optima Trade Marketsection */}
      <motion.div
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
      ...
      >
        <h2 className='text-3xl md:text-4xl font-semibold'>
          Why EquitrustMarkets
        </h2>
        <p className='text-gray-600 mt-2 max-w-xl mx-auto'>
          Better-than-market conditions, unique features, and cutting-edge
          security, partnered with our dedication to transparency and excellent
          customer service, are the reasons traders continue to choose
          EquitrustMarkets.
        </p>
      </motion.div>
