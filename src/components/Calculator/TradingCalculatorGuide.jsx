...
export default function TradingCalculatorGuide() {
  return (
    <section className='px-4 py-12 max-w-6xl mx-auto text-center'>
      ...
      >
        How to use the Optima Trade Markettrading calculator
      </motion.h2>
      ...
      >
        <img
          src={guideImage}
          alt='Optima Trade Markettrading calculator guide'
        ...
        <div className='grid md:grid-cols-3 gap-4 mt-6 text-left'>
          {[
            {
              step: 'Step 1',
              text: 'Choose your Optima Trade Marketaccount type and specify your account’s leverage and currency.',
            },
            {
              step: 'Step 2',
