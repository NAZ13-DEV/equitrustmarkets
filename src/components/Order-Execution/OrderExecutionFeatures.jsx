    ...
    <section className='bg-white py-20 px-6'>
      <div className='max-w-6xl mx-auto text-center'>
        <h2 className='text-2xl sm:text-3xl font-bold text-[#142528] mb-2'>
          Order execution process at Optima Trade Market
        </h2>
        <p className='text-[#3f6870] mb-12 text-sm sm:text-base'>
          Here’s why over 1 million active traders choose to execute their
          trading strategies at Optima Trade Market.
        </p>
