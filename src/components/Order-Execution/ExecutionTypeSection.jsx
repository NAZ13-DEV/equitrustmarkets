    ...
    <section className='bg-white py-20 px-6'>
      <div className='max-w-6xl mx-auto text-center'>
        ...
        <p className='text-[#3f6870] text-sm sm:text-base max-w-xl mx-auto mb-12'>
          Optima Trade Market offers two types of order execution, both built on
          sophisticated algorithms to provide a seamless experience.
        </p>
        ...
        <div className='flex flex-col-reverse lg:flex-row items-center justify-between gap-10'>
          ...
          <div className='text-left max-w-lg'>
            ...
            <p className='text-[#3f6870] text-sm mb-6 leading-relaxed'>
              Open trades at the price you request or approve, or not at all.
              This is ideal for traders whose strategies revolve around price
              certainty, and who have strict risk management parameters.
            </p>

            <h3 className='text-lg font-semibold text-[#142528] mb-2'>
              Instant execution at Optima Trade Market
            </h3>
            <p className='text-[#3f6870] text-sm leading-relaxed'>
              Our complex algorithms are designed to provide stable pricing so
              you can experience a smooth execution process with the lowest
              requote rate possible.
            </p>
          </div>
