        ...
        <div className='grid grid-cols-1 md:grid-cols-2'>
          <div className='hidden md:flex flex-col justify-between px-10 py-12 bg-[#f0fbf6]'>
            <div className='space-y-4'>
              <img
                ...
                className='w-14 h-14'
              />
              <h2 className='text-3xl font-bold text-[#142528]'>
                Welcome back
              </h2>
              <p className='text-[#3f6870] text-sm leading-relaxed'>
                Secure gateway to advanced broker tools. Track portfolio, manage
                margin, and stay in control.
              </p>
            </div>
          ...
          <div className='flex flex-col justify-center px-8 py-10'>
            <div className='w-full max-w-md mx-auto'>
              <h2 className='text-2xl font-bold text-[#142528] mb-1'>
                Sign in to Broker Portal
              </h2>
              <p className='text-sm text-[#3f6870] mb-6'>
                Access your account and trading suite
              </p>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
                ...
                <button
                  ...
                  className={`w-full py-2 rounded-md font-semibold text-white transition shadow-lg text-lg ${
                    isSubmitting
                      ? 'bg-[#07A658]/60 cursor-not-allowed'
                      : 'bg-[#07A658] hover:bg-[#059c4d]'
                  }`}
                >
                  {isSubmitting ? (
