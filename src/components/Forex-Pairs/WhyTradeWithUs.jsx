...
const features = [
  {
    ...
    description:
      'Trade with confidence using Equitrustmarkets’ market protection tools that help defend your positions from sudden volatility and avoid forced stop-outs.',
  },
  {
    icon: stable,
  ...
  return (
    <section className="bg-white py-20 px-4">
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          Why trade forex with Equitrustmarkets
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          Join a trusted platform and trade top currency pairs using powerful tools and reliable execution—backed by award-winning infrastructure.
        </motion.p>
