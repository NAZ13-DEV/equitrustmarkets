...
const faqs = [
  {
    ...
    answer:
      'The maximum lot size varies by instrument and market conditions. Check the instrument specifications within your Equitrustmarkets dashboard for detailed limits.',
  },
  {
