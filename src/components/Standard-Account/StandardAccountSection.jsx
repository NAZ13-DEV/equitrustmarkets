  ...
  return (
    <section className="w-full bg-white px-4 py-20">
      <div className="max-w-5xl mx-auto">
        ...
        >
          Feature-rich, commission-free trading accounts built for today’s active traders. 
          Experience tight spreads, no hidden fees, and fast execution—making the Standard account 
          the perfect starting point for beginners and pros alike. Join EquitrustMarkets and discover 
