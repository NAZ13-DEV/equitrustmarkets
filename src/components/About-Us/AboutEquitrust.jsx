      ...
      <div className='relative z-10 max-w-7xl mx-auto px-6 py-24 flex flex-col lg:flex-row items-start justify-between'>
        <div className='max-w-xl text-left'>
          <h2 className='text-4xl font-bold text-[#142528] mb-4'>
            This is Optima Trade Market
          </h2>
          <p className='text-[#3f6870] text-base leading-relaxed'>
            Optima Trade Marketis a multi-asset, tech-focused brokerage
            delivering precision and performance through algorithmic trading
            solutions. We empower traders with cutting-edge tools, data
            transparency, and seamless execution under any market condition.
          </p>
